...
- **[The item editor and gates](https://mmacy.github.io/osr-editor/guides/item-editor/)** — the authored layer's opening: bundle bespoke equipment beside the shipped catalog (the brass key the module is about), cache it, and gate doors and transitions on carrying it — with authored refusal and success text, tolls that consume, and per-level narrator guidance.
