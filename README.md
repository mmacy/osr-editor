...
- **[Stocking and keyed content](https://mmacy.github.io/osr-editor/guides/stocking-and-keyed-content/)** — the map-first stocking flow, through type-ahead pickers that never author a dangling reference, with a page per content kind: [encounters](https://mmacy.github.io/osr-editor/guides/encounters/), [treasure](https://mmacy.github.io/osr-editor/guides/treasure/), [traps](https://mmacy.github.io/osr-editor/guides/traps/), and [features](https://mmacy.github.io/osr-editor/guides/features/).
