...
A specific item, a named valuable, or a counted pile of coins is a [feature](features.md), not a treasure declaration — features hold item ids from the equipment catalog, explicit coins, and named valuables, and a treasure cache feature can have [its own trap](traps.md). Use the treasure card when you want the tables to decide, and a feature when you already know what's in the room.
